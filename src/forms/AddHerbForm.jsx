...
const AddHerbForm = (props) => {
    ...
    const initHerb = {
        id: null,
        name: '',
        characteristics: {id: null, title: '', hasHighBloodPressure: true, child: true, pregnant: false},
    ...
    */
    ...
    return (
        <form>
            ...
            <input className="u-full-width" type="checkbox" name="pregnant" checked={herb.characteristics.pregnant} onChange={handleChange}/>
